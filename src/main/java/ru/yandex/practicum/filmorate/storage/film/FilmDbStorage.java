...
public class FilmDbStorage implements FilmStorage {
    ...
    public Film getFilmById(Long id) {
        String sql = "SELECT * FROM FILMS AS F " +
                ...
                "LEFT JOIN MPA_RATING MR ON MR.RATING_ID = F.MPA_RATING_ID " +
    ...
    public Film update(Film film) {
        jdbcTemplate.update("MERGE INTO FILMS (FILM_ID, FILM_NAME, DESCRIPTION, RELEASE_DATE, DURATION," +
    ...
    public List<Film> getHighlyRatedFilms(Long count) {
        String sql = "SELECT F.FILM_ID FROM FILM_LIKES FL " +
